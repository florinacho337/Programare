class Grammar:
    def __init__(self, start_symbol, terminals=None, non_terminals=None):
    ...
    def read_rules_from_file(self, file_path):
        with open(file_path, "r") as file:
            for line in file:
                ...
                production = list(production_str.strip())
                ...
                for symbol in production:
                    if symbol.isupper() and symbol not in self.non_terminals:
                        self.non_terminals.append(symbol)
                    elif not symbol.isupper() and symbol != 'ε' and symbol not in self.terminals:

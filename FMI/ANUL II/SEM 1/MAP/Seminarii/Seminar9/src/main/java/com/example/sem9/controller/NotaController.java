...
//                .toList());
        Predicate<NotaDto> byName = notaDto -> notaDto.getStudentName().startsWith(textFieldName.getText());
        Predicate<NotaDto> byNota = notaDto -> textFieldNota.getText().isEmpty() ||
                notaDto.getNota() > Double.parseDouble(textFieldNota.getText());
        Predicate<NotaDto> byTema = notaDto -> notaDto.getTemaId().startsWith(textFieldTema.getText());
        list = list.stream()
